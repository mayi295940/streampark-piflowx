...
public class PDB {
    ...
    private void parsePDBBioJava() {
         ...
         * fileParsingParameters.setAlignSeqRes(true); pdbreader.setFileParsingParameters(fileParsingParameters);
         */
        try {
            ...
            if (pdbHeader.getExperimentalTechniques() != null) {
                Iterator<ExperimentalTechnique> experimentalTechniqueIterator =
                    pdbHeader.getExperimentalTechniques().iterator();
