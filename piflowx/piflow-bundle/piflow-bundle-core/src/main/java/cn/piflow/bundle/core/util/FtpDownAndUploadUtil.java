...
public class FtpDownAndUploadUtil {
   ...
   * @param
   */
  public void uploadFtp(FTPClient ftpClient, String ftpPath, String hdfsSourcePath)
      throws Exception {
    ...
    try {
      remotePath =
          ftpPath
              + "/"
              + new String(
                  relativePath.getBytes(StandardCharsets.UTF_8), FTP.DEFAULT_CONTROL_ENCODING);
  ...
  public FTPClient getFtpClient(
      String host, Integer port, String username, String password, String defaultFSUrl)
      throws Exception {
  ...
  public void mkdirsFtpPath(FTPClient ftpClient, String ftpPath) {
    try {
      ...
      while (end > start) {
        String subDirectory =
            new String(ftpPath.substring(0, end).getBytes("GBK"), StandardCharsets.ISO_8859_1);
   ...
   * @throws Exception
   */
  public void downloadFromFtpAndUploadToHdfs(
      FTPClient ftpClient, String ftpPath, String hdfsFolderPath) throws Exception {
   ...
   * @throws Exception
   */
  public void downloadFolder(FTPClient ftpClient, String ftpPath, String hdfsFolderPath)
      throws Exception {
   ...
   * @throws Exception
   */
  public void downloadFile(FTPClient ftpClient, String ftpPath, String localFolderPath)
      throws Exception {
   ...
   * @throws Exception
   */
  public void downloadFromFtpUtil(FTPClient ftpClient, String path, String hdfsPath)
      throws Exception {
