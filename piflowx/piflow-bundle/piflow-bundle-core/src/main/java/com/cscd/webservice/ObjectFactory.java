...
public class ObjectFactory {
  ...
  @XmlElementDecl(
      namespace = "http://webservice.cscd.com",
      name = "return",
      scope = SearchByExprResponse.class)
  ...
  @XmlElementDecl(
      namespace = "http://webservice.cscd.com",
      name = "return",
      scope = SearchByExprRangeResponse.class)
  ...
  @XmlElementDecl(
      ...
      scope = CscdServiceException.class)
  ...
  @XmlElementDecl(
      namespace = "http://webservice.cscd.com",
      name = "return",
      scope = GetArticlesResponse.class)
  ...
  @XmlElementDecl(
      namespace = "http://webservice.cscd.com",
      name = "return",
      scope = GetCitedInfoResponse.class)
  ...
  @XmlElementDecl(
      namespace = "http://webservice.cscd.com",
      name = "return",
      scope = SearchArticlesResponse.class)
  ...
  @XmlElementDecl(
      namespace = "http://webservice.cscd.com",
      name = "Message",
      scope = java.lang.Exception.class)
