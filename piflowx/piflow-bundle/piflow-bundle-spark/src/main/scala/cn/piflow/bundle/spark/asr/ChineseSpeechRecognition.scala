...
package cn.piflow.bundle.spark.asr
...
class ChineseSpeechRecognition extends ConfigurableStop[DataFrame] {
  ...
  override def getPropertyDescriptor(): List[PropertyDescriptor] = {
    ...
    val audioPath = new PropertyDescriptor()
      .name("audioPath")
      .displayName("audioPath")
      .description("The path of audio file")
      .defaultValue("")
      .required(true)
    ...
    val url = new PropertyDescriptor()
      ...
      .defaultValue("http://10.0.86.128:8081/service/classify/asr/")
      .required(false)
