...
class CephRead extends ConfigurableStop[Null, DataFrame, Null] {
  ...
  override def getPropertyDescriptor(): List[PropertyDescriptor] = {
    ...
    val cephAccessKey = new PropertyDescriptor()
      ...
      .description("This parameter is of type String and " +
        "represents the access key used to authenticate " +
