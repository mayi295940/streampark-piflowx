...
class ExcelRead extends ConfigurableStop[Null, DataFrame, Null] {
  ...
  override def getPropertyDescriptor(): List[PropertyDescriptor] = {
    ...
    val dataAddress = new PropertyDescriptor()
      ...
      .description(
        "The location of data to read or write can be specified with the dataAddress option, Currently the following address styles are supported:" +
