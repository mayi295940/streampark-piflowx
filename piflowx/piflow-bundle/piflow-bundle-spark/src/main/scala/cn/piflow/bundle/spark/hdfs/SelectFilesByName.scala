...
class SelectFilesByName extends ConfigurableStop[Null, DataFrame, Null] {
  ...
  override def perform(
    ...
    val fields: Array[StructField] =
      "path".split(Constants.SINGLE_SLASH).map(d => StructField(d, StringType, nullable = true))
