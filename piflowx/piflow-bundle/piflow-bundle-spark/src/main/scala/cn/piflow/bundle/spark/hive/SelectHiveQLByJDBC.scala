...
class SelectHiveQLByJDBC extends ConfigurableStop[DataFrame] {
  ...
  override val description: String =
    "some hive can only achieve by jdbc, this stop is designed for this"
  ...
  override def getPropertyDescriptor(): List[PropertyDescriptor] = {
    ...
    val jdbcUrl = new PropertyDescriptor()
      ...
      .defaultValue(
        "jdbc:hive2://packone12:2181,packone13:2181,packone11:2181/middle;serviceDiscoveryMode=zooKeeper;zooKeeperNamespace=hiveserver2")
      .required(true)
  ...
  private def getDF(sqlContext: SQLContext, sc: SparkContext, tableName: String): DataFrame = {
  ...
  private def getJDBCDF(sqlContext: SQLContext, sc: SparkContext, tableName: String): DataFrame = {
