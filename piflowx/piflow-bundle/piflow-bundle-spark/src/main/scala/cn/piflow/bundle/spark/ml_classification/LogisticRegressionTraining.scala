...
class LogisticRegressionTraining extends ConfigurableStop[Null, DataFrame, Null] {
  ...
  override def getPropertyDescriptor(): List[PropertyDescriptor] = {
    ...
    val maxIter = new PropertyDescriptor()
      ...
      .description("Param for maximum number of iterations")
      .defaultValue("")
      .required(false)

    val minTol = new PropertyDescriptor()
      .name("minTol")
      .displayName("MIN_TOL")
      .description("Param for the convergence tolerance for iterative algorithms (>= 0)")
      .defaultValue("")
      .required(false)

    val regParam = new PropertyDescriptor()
      .name("regParam")
      .displayName("REG_PARAM")
      .description("Param for regularization parameter (>= 0)")
      .defaultValue("")
      .required(false)

    val elasticNetParam = new PropertyDescriptor()
      .name("elasticNetParam")
      .displayName("ELASTIC_NET_PARAM")
      .description("Param for the ElasticNet mixing parameter, in range [0, 1]")
      .defaultValue("")
      .required(false)

    val threshold = new PropertyDescriptor()
      .name("threshold")
    ...
    val family = new PropertyDescriptor()
      .name("family")
      .displayName("FAMILY")
      .description("Param for the name of family which is a description of " +
