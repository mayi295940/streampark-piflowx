...
class RandomForestTraining extends ConfigurableStop[Null, DataFrame, Null] {
  ...
  def perform(
    ...
    // Param for the name of family which is a description of the
  ...
  override def getPropertyDescriptor(): List[PropertyDescriptor] = {
    ...
    val minInfoGain = new PropertyDescriptor()
      ...
      .description("Minimum information gain for a split to be " +
    ...
    val impurity = new PropertyDescriptor()
      ...
      .description("Criterion used for information gain calculation (case-insensitive)." +
    ...
    val featureSubsetStrategy = new PropertyDescriptor()
      .name("featureSubsetStrategy")
      .displayName("FEATURE_SUBSET_STRATEGY")
      .description("The number of features to consider for splits at each tree node.")
      .defaultValue("")
      .required(false)

    val numTrees = new PropertyDescriptor()
      .name("numTrees")
      .displayName("NUM_TREES")
