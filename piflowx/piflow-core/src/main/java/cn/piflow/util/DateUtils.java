...
public class DateUtils {
     ...
     *
     * @param i One day after the positive number is obtained, and one day before the negative number
     *     is obtained.
     * @throws ParseException
     */
    ...
    /**
     * Compare the difference between the two dates. If the start date is earlier than the end date,
     * return the positive number, otherwise return the negative number.
     *
     * @param start
     * @param end
     * @return
    ...
    /**
     * Compare the milliseconds difference between the two dates. If the start date is earlier than
     * the end date, the positive number is returned, otherwise the negative number is returned.
     *
