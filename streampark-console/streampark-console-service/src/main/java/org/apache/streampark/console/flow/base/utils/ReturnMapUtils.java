...
public class ReturnMapUtils {
    ...
    public static Map<String, Object> setSucceededMsg(String succeededMsg) {
        succeededMsg =
            (StringUtils.isNotBlank(succeededMsg) ? succeededMsg : MessageConfig.SUCCEEDED_MSG());
     ...
     * @return Map
     */
    public static Map<String, Object> appendValues(
                                                   Map<String, Object> rtnMap, String key, Object value) {
        if (null == rtnMap) {
            rtnMap = new HashMap<>();
        }
        rtnMap.put(key, value);
