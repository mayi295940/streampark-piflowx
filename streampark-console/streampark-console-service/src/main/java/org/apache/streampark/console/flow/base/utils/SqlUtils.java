...
public class SqlUtils {
  ...
  /**
   * str(Add a single quote to the string and replace the single quote in the string with a double
   * quote)
   *
   * @param str
   * @return
  ...
  public static String baseFieldValuesNoId(BaseModelUUIDNoCorpAgentId baseInfo) {
    ...
    Date lastUpdateDttm =
        (null == baseInfo.getLastUpdateDttm()) ? new Date() : baseInfo.getLastUpdateDttm();
