...
public class ApiConfig {
    ...
    public static String getStopsHubPathUrl() {
        return SysParamsCache.INTERFACE_URL_HEAD + STOPSHUB_PATH;
    }
    ...
    public static String getStopsHubMountUrl() {
        return SysParamsCache.INTERFACE_URL_HEAD + STOPSHUB_MOUNT_PATH;
    }
    ...
    public static String getStopsHubUNMountUrl() {
        return SysParamsCache.INTERFACE_URL_HEAD + STOPSHUB_UNMOUNT_PATH;
    }
    ...
    public void setSparkJarPath(String sparkJarPath) {
        SPARK_JAR_PATH = sparkJarPath;
    }

    public static String getSparkJarPathUrl() {
        return SysParamsCache.INTERFACE_URL_HEAD + SPARK_JAR_PATH;
    }
    ...
    public static String getSparkJarMountUrl() {
        return SysParamsCache.INTERFACE_URL_HEAD + SPARK_JAR_MOUNT_PATH;
    }
    ...
    public static String getSparkJarUNMountUrl() {
        return SysParamsCache.INTERFACE_URL_HEAD + SPARK_JAR_UNMOUNT_PATH;
    }
