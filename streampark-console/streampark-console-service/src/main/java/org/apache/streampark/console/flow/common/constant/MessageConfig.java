...
public class MessageConfig {
  ...
  private void setInterfaceCallSucceededValueNullErrorMsg(
      String interfaceCallSucceededValueNullErrorMsg) {
  ...
  private void setInterfaceCallSucceededValueNullErrorMsgZh(
      String interfaceCallSucceededValueNullErrorMsgZh) {
  ...
  private void setInterfaceCallSucceededConversionErrorMsg(
      String interfaceCallSucceededConversionErrorMsg) {
  ...
  private void setInterfaceCallSucceededConversionErrorMsgZh(
      String interfaceCallSucceededConversionErrorMsgZh) {
  ...
  private void setInterfaceCallSucceededSaveErrorMsgZh(
      String interfaceCallSucceededSaveErrorMsgZh) {
