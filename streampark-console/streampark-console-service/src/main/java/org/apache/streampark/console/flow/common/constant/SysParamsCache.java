...
public class SysParamsCache {
  ...
  public static String getStopsHubPathUrl() {
    return INTERFACE_URL_HEAD + STOPSHUB_PATH;
  }
  ...
  public static String getStopsHubMountUrl() {
    return INTERFACE_URL_HEAD + STOPSHUB_MOUNT_PATH;
  }
  ...
  public static String getStopsHubUNMountUrl() {
    return INTERFACE_URL_HEAD + STOPSHUB_UNMOUNT_PATH;
  }
  ...
  public static String getSparkJarPathUrl() {
    return INTERFACE_URL_HEAD + SPARK_JAR_PATH;
  }
  ...
  public static String getSparkJarMountUrl() {
    return INTERFACE_URL_HEAD + SPARK_JAR_MOUNT_PATH;
  }
  ...
  public static String getSparkJarUNMountUrl() {
    return INTERFACE_URL_HEAD + SPARK_JAR_UNMOUNT_PATH;
  }
