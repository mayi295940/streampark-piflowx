...
import org.apache.streampark.console.flow.component.dataSource.jpa.repository.DataSourcePropertyJpaRepository;
import zio.schema.validation.Predicate$;

@Component
public class DataSourcePropertyDomain {

  @Resource private DataSourcePropertyJpaRepository dataSourcePropertyJpaRepository;

  private Specification<DataSourceProperty> addEnableFlagParam() {
    Specification<DataSourceProperty> specification =
        new Specification<DataSourceProperty>() {

          private static final long serialVersionUID = 1L;

          @Override
          public Predicate toPredicate(
              Root<DataSourceProperty> root,
              CriteriaQuery<?> query,
