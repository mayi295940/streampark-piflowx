...
public class DataSourceUtils {
    ...
    if (null != dataSource) {
      ...
      if (isToAll) {
        List<DataSourcePropertyVo> dataSourcePropertyVoList =
            dataSourcePropertyListPoToVo(dataSource.getDataSourcePropertyList());
   ...
   * @return
   */
  public static List<DataSourcePropertyVo> dataSourcePropertyListPoToVo(
   ...
   * @return
   */
  public static List<DataSourceVo> dataSourceListPoToVo(
      List<DataSource> dataSourceList, boolean isToAll) {
