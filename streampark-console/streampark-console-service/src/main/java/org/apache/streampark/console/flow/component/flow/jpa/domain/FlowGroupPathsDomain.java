...
import org.apache.streampark.console.flow.component.flow.jpa.repository.FlowGroupPathsJpaRepository;
import zio.schema.validation.Predicate$;

@Component
public class FlowGroupPathsDomain {

  @Autowired private FlowGroupPathsJpaRepository flowGroupPathsJpaRepository;

  private Specification<FlowGroupPaths> addEnableFlagParam() {
    Specification<FlowGroupPaths> specification =
        new Specification<FlowGroupPaths>() {

          private static final long serialVersionUID = 1L;

          @Override
          public Predicate toPredicate(
              Root<FlowGroupPaths> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
