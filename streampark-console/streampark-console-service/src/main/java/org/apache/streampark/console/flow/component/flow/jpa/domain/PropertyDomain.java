...
import org.apache.streampark.console.flow.component.flow.jpa.repository.PropertyJpaRepository;
import zio.schema.validation.Predicate$;

@Component
public class PropertyDomain {

  @Autowired private PropertyJpaRepository propertyJpaRepository;

  private Specification<Property> addEnableFlagParam() {
    Specification<Property> specification =
        new Specification<Property>() {
          private static final long serialVersionUID = 1L;

          @Override
          public Predicate toPredicate(
              Root<Property> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
