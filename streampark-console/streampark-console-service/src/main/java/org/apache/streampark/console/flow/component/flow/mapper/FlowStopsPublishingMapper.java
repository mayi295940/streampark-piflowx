...
public interface FlowStopsPublishingMapper {
    ...
    @Results({
            @Result(column = "stops_id", property = "stopsVo", one = @One(select = "org.apache.streampark.console.flow.component.flow.mapper.StopsMapper.getStopsVoById", fetchType = FetchType.LAZY))
    })
    ...
    /** Get FlowStopsPublishing List by flowId */
    @Select("SELECT DISTINCT fs.fk_flow_id "
