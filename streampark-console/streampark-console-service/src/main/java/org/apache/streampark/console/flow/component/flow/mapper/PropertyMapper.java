...
public interface PropertyMapper {
    ...
    @Select("select fs.* from flow_stops fs "
    ...
    @Results({
            ...
            @Result(property = "properties", column = "id", many = @Many(select = "org.apache.streampark.console.flow.component.flow.mapper.PropertyMapper.getPropertyByStopsId", fetchType = FetchType.LAZY)),
            @Result(property = "customizedPropertyList", column = "id", many = @Many(select = "org.apache.streampark.console.flow.component.flow.mapper.CustomizedPropertyMapper.getCustomizedPropertyListByStopsId", fetchType = FetchType.LAZY))
    })
     ...
     * @param id id
     */
    @Select("select fsp.id, fsp.name, fsp.description,fsp.display_name,fsp.custom_value,fsp.version,"
    ...
    @Select("select fsp.id, fsp.name, fsp.description,fsp.display_name,fsp.custom_value,"
