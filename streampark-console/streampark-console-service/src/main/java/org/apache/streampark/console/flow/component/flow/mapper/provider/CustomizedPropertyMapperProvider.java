...
public class CustomizedPropertyMapperProvider {
  ...
  private void preventSQLInjectionCustomizedProperty(CustomizedProperty getPropertyBySotpsId) {
    if (null != getPropertyBySotpsId
        && StringUtils.isNotBlank(getPropertyBySotpsId.getLastUpdateUser())) {
      // Mandatory Field
      ...
      String stopsIdStr =
          (null != getPropertyBySotpsId.getStops()
              ? getPropertyBySotpsId.getStops().getId()
              : null);
  ...
  public String addCustomizedPropertyList(Map map) {
    List<CustomizedProperty> customizedPropertyList =
        (List<CustomizedProperty>) map.get("customizedPropertyList");
