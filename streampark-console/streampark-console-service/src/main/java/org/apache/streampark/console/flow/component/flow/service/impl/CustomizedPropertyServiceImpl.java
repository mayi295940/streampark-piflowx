...
import org.apache.streampark.console.flow.component.flow.mapper.CustomizedPropertyMapper;
...
import org.apache.streampark.console.flow.component.flow.service.ICustomizedPropertyService;
...
public class CustomizedPropertyServiceImpl implements ICustomizedPropertyService {
  ...
  public String addStopCustomizedProperty(
    ...
    List<CustomizedProperty> customizedPropertyListByStopsIdAndName =
        customizedPropertyMapper.getCustomizedPropertyListByStopsIdAndName(
  ...
  public String updateStopsCustomizedProperty(
    ...
    int optDataCount =
        customizedPropertyMapper.updateCustomizedPropertyCustomValue(
  ...
  public String getRouterStopsCustomizedProperty(String customPropertyId) {
    ...
    CustomizedProperty customizedPropertyById =
        customizedPropertyMapper.getCustomizedPropertyById(customPropertyId);
          ...
          if (null != pathsList && pathsList.size() > 0) {
            ...
            for (Paths paths : pathsList) {
              ...
              Stops stopByFlowIdAndStopPageId =
                  stopsMapper.getStopByFlowIdAndStopPageId(flowId, paths.getTo());
