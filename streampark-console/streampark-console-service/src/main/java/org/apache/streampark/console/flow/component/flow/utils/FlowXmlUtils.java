...
import org.apache.streampark.console.flow.base.utils.StringCustomUtils;
...
public class FlowXmlUtils {
  ...
  public static String flowAndStopInfoToXml(Flow flow, String xmlStr) {
    ...
    if (null != stopsList && stopsList.size() > 0) {
      for (Stops stops : stopsList) {
        stops =
            StopsUtils.fillStopsPropertiesByDatasource(
                stops, stops.getDataSource(), stops.getCrtUser());
        if (null == stops) {
          continue;
        }
        ...
        if (null != propertyList && propertyList.size() > 0) {
          ...
          for (Property property : propertyList) {
            ...
            String displayName =
                StringCustomUtils.replaceSpecialSymbolsXml(property.getDisplayName());
            String propertyName = StringCustomUtils.replaceSpecialSymbolsXml(property.getName());
            String customValue =
                StringCustomUtils.replaceSpecialSymbolsXml(property.getCustomValue());
            String propertyDescription =
                StringCustomUtils.replaceSpecialSymbolsXml(property.getDescription());
            String allowableValues =
                StringCustomUtils.replaceSpecialSymbolsXml(property.getAllowableValues());
            boolean required = property.getRequired();
            boolean sensitive = property.getSensitive();
            boolean isSelect = property.getIsSelect();
            String propertyVocrtUser =
                StringCustomUtils.replaceSpecialSymbolsXml(property.getCrtUser());
        ...
        if (null != customizedPropertyList && customizedPropertyList.size() > 0) {
          ...
          for (CustomizedProperty customizedProperty : customizedPropertyList) {
            ...
            String customizedId =
                StringCustomUtils.replaceSpecialSymbolsXml(customizedProperty.getId());
            String customizedName =
                StringCustomUtils.replaceSpecialSymbolsXml(customizedProperty.getName());
            String customizedValue =
                StringCustomUtils.replaceSpecialSymbolsXml(customizedProperty.getCustomValue());
            String propertyDescription =
                StringCustomUtils.replaceSpecialSymbolsXml(customizedProperty.getDescription());
            String propertyVocrtUser =
                StringCustomUtils.replaceSpecialSymbolsXml(customizedProperty.getCrtUser());
      ...
      if (null != pathsList && pathsList.size() > 0) {
        for (Paths paths : pathsList) {
          ...
          String filterCondition =
              StringCustomUtils.replaceSpecialSymbolsXml(paths.getFilterCondition());
          if (StringUtils.isNotBlank(crtUser)) {
            xmlStrSb.append(spliceStr("crtUser", crtUser));
          }
  ...
  public static String flowGroupToXmlStr(FlowGroup flowGroup) {
    ...
    if (null != flowGroup) {
      ...
      String mxGraphModelXml =
          MxGraphUtils.mxGraphModelToMxGraph(true, flowGroup.getMxGraphModel());
      ...
      String flowGroupPathsListXmlStr =
          flowGroupPathsListToXmlStr(flowGroup.getFlowGroupPathsList());
  ...
  public static MxGraphModelVo xmlToMxGraphModel(String xmlData) {
    ...
    try {
      ...
      String grid =
          StringCustomUtils.recoverSpecialSymbolsXml(mxGraphModelXml.attributeValue("grid"));
      String gridSize =
          StringCustomUtils.recoverSpecialSymbolsXml(mxGraphModelXml.attributeValue("gridSize"));
      String guides =
          StringCustomUtils.recoverSpecialSymbolsXml(mxGraphModelXml.attributeValue("guides"));
      String tooltips =
          StringCustomUtils.recoverSpecialSymbolsXml(mxGraphModelXml.attributeValue("tooltips"));
      String connect =
          StringCustomUtils.recoverSpecialSymbolsXml(mxGraphModelXml.attributeValue("connect"));
      String arrows =
          StringCustomUtils.recoverSpecialSymbolsXml(mxGraphModelXml.attributeValue("arrows"));
      String fold =
          StringCustomUtils.recoverSpecialSymbolsXml(mxGraphModelXml.attributeValue("fold"));
      String page =
          StringCustomUtils.recoverSpecialSymbolsXml(mxGraphModelXml.attributeValue("page"));
      String pageScale =
          StringCustomUtils.recoverSpecialSymbolsXml(mxGraphModelXml.attributeValue("pageScale"));
      String pageWidth =
          StringCustomUtils.recoverSpecialSymbolsXml(mxGraphModelXml.attributeValue("pageWidth"));
      String pageHeight =
          StringCustomUtils.recoverSpecialSymbolsXml(mxGraphModelXml.attributeValue("pageHeight"));
      String background =
          StringCustomUtils.recoverSpecialSymbolsXml(mxGraphModelXml.attributeValue("background"));
      ...
      Iterator rootiter =
          rootjd.elementIterator("mxCell"); // Get the child node "mxCell" under the root node
      while (rootiter.hasNext()) {
        MxCellVo mxCellVo = new MxCellVo();
        MxGeometryVo mxGeometryVo = null;
        Element recordEle = (Element) rootiter.next();
        String mxCellId =
            StringCustomUtils.recoverSpecialSymbolsXml(recordEle.attributeValue("id"));
        String parent =
            StringCustomUtils.recoverSpecialSymbolsXml(recordEle.attributeValue("parent"));
        String style =
            StringCustomUtils.recoverSpecialSymbolsXml(recordEle.attributeValue("style"));
        String edge = StringCustomUtils.recoverSpecialSymbolsXml(recordEle.attributeValue("edge"));
        String source =
            StringCustomUtils.recoverSpecialSymbolsXml(recordEle.attributeValue("source"));
        String target =
            StringCustomUtils.recoverSpecialSymbolsXml(recordEle.attributeValue("target"));
        String value =
            StringCustomUtils.recoverSpecialSymbolsXml(recordEle.attributeValue("value"));
        String vertex =
            StringCustomUtils.recoverSpecialSymbolsXml(recordEle.attributeValue("vertex"));
        if ("1".equals(edge)) {
        ...
        if (StringUtils.isNotBlank(style)) {
          ...
          String relative =
              StringCustomUtils.recoverSpecialSymbolsXml(mxGeometry.attributeValue("relative"));
          ...
          String width =
              StringCustomUtils.recoverSpecialSymbolsXml(mxGeometry.attributeValue("width"));
          String height =
              StringCustomUtils.recoverSpecialSymbolsXml(mxGeometry.attributeValue("height"));
   ...
   * @return MxGraphModel
   */
  public static MxGraphModel xmlToMxGraphModel(
      String xmlData, int maxPageId, String username, Boolean isAppend) {
    ...
    try {
      ...
      while (rootiter.hasNext()) {
        ...
        if (StringUtils.isNotBlank(style)) {
          ...
          String relative =
              StringCustomUtils.recoverSpecialSymbolsXml(mxGeometryXml.attributeValue("relative"));
          String as =
              StringCustomUtils.recoverSpecialSymbolsXml(mxGeometryXml.attributeValue("as"));
          ...
          String width =
              StringCustomUtils.recoverSpecialSymbolsXml(mxGeometryXml.attributeValue("width"));
          String height =
              StringCustomUtils.recoverSpecialSymbolsXml(mxGeometryXml.attributeValue("height"));
  ...
  public static FlowGroupPaths xmlToFlowGroupPaths(String xmlData, int maxPageId, String username) {
    ...
    String from =
        StringCustomUtils.recoverSpecialSymbolsXml(flowGroupPathsElement.attributeValue("from"));
    String to =
        StringCustomUtils.recoverSpecialSymbolsXml(flowGroupPathsElement.attributeValue("to"));
    String outPort =
        StringCustomUtils.recoverSpecialSymbolsXml(flowGroupPathsElement.attributeValue("outport"));
    String inPort =
        StringCustomUtils.recoverSpecialSymbolsXml(flowGroupPathsElement.attributeValue("inport"));
    String pageId =
        StringCustomUtils.recoverSpecialSymbolsXml(flowGroupPathsElement.attributeValue("pageId"));
  ...
  public static Paths xmlToPathsOne(String xmlData, int maxPageId, String username) {
    ...
    try {
      ...
      Element pathsElement =
          rootElt.element("paths"); // Get the child node "paths" under the root node
      ...
      String outport =
          StringCustomUtils.recoverSpecialSymbolsXml(pathsElement.attributeValue("outport"));
      String inport =
          StringCustomUtils.recoverSpecialSymbolsXml(pathsElement.attributeValue("inport"));
      String pageId =
          StringCustomUtils.recoverSpecialSymbolsXml(pathsElement.attributeValue("pageId"));
      String filterCondition =
          StringCustomUtils.recoverSpecialSymbolsXml(
              pathsElement.attributeValue("filterCondition"));
  ...
  public static Stops xmlToStops(String xmlData, int maxPageId, String username) {
    ...
    try {
      ...
      String pageId =
          StringCustomUtils.recoverSpecialSymbolsXml(stopElement.attributeValue("pageId"));
      String inPortType =
          StringCustomUtils.recoverSpecialSymbolsXml(stopElement.attributeValue("inPortType"));
      String inports =
          StringCustomUtils.recoverSpecialSymbolsXml(stopElement.attributeValue("inports"));
      String outPortType =
          StringCustomUtils.recoverSpecialSymbolsXml(stopElement.attributeValue("outPortType"));
      String outports =
          StringCustomUtils.recoverSpecialSymbolsXml(stopElement.attributeValue("outports"));
      String isCheckpoint =
          StringCustomUtils.recoverSpecialSymbolsXml(stopElement.attributeValue("isCheckpoint"));
      String owner =
          StringCustomUtils.recoverSpecialSymbolsXml(stopElement.attributeValue("owner"));
      String groups =
          StringCustomUtils.recoverSpecialSymbolsXml(stopElement.attributeValue("groups"));
      // stops.setId(id);
      ...
      if (null != propertyXmlIterator) {
        ...
        while (propertyXmlIterator.hasNext()) {
          ...
          // String propertyId =
          // StringCustomUtils.recoverSpecialSymbolsXml(propertyValue.attributeValue("id"));
          String allowableValues =
              StringCustomUtils.recoverSpecialSymbolsXml(
                  propertyValue.attributeValue("allowableValues"));
          String customValue =
              StringCustomUtils.recoverSpecialSymbolsXml(
                  propertyValue.attributeValue("customValue"));
          String propertyDescription =
              StringCustomUtils.recoverSpecialSymbolsXml(
                  propertyValue.attributeValue("description"));
          String displayName =
              StringCustomUtils.recoverSpecialSymbolsXml(
                  propertyValue.attributeValue("displayName"));
          String propertyName =
              StringCustomUtils.recoverSpecialSymbolsXml(propertyValue.attributeValue("name"));
  ...
  public static Flow xmlToFlow(String xmlData, int maxPageId, String username, Boolean isAppend) {
    ...
    try {
      ...
      MxGraphModel mxGraphModel =
          xmlToMxGraphModel(mxGraphModelElement.asXML(), maxPageId, username, isAppend);
   ...
   * @return FlowGroup
   */
  public static Map<String, Object> XmlStrToFlowGroup(
      String flowGroupXmlStr,
      int maxPageId,
      String username,
      String[] flowNames,
      boolean isChildren) {
    ...
    try {
      ...
      String name =
          StringCustomUtils.recoverSpecialSymbolsXml(flowGroupElement.attributeValue("name"));
      String description =
          StringCustomUtils.recoverSpecialSymbolsXml(
              flowGroupElement.attributeValue("description"));
      String flowGroupPageId =
          StringCustomUtils.recoverSpecialSymbolsXml(flowGroupElement.attributeValue("pageId"));
      flowGroupPageId =
          StringUtils.isNotBlank(flowGroupPageId)
              ? ((Integer.parseInt(flowGroupPageId) + maxPageId) + "")
              : "";
      ...
      while (flowGroupListXmlIterator.hasNext()) {
        ...
        Map<String, Object> stringObjectMap =
            XmlStrToFlowGroup(recordEle.asXML(), 1, username, new String[] {}, true);
      ...
      MxGraphModel mxGraphModel =
          xmlToMxGraphModelNew(mxGraphModelXmlAsXML, maxPageId, username, null, flowGroup);
      if (isChildren) {
  ...
  public static Map<String, Object> flowTemplateXmlToFlow(
      String templateXml,
      String username,
      String stopMaxPageId,
      String flowMaxPageId,
      String[] stopNames) {
    ...
    try {
      ...
      // stop
      Iterator stopXmlIterator = flowElement.elementIterator("stop");
      Map<String, Object> xmlToStopsMap =
          xmlToStopsList(stopXmlIterator, stopMaxPageIdInt, username, stopNames, flow);
      ...
      Element mxGraphModelElement = flowElement.element("mxGraphModel");
      MxGraphModel mxGraphModel =
          xmlToMxGraphModelNew(mxGraphModelElement.asXML(), stopMaxPageIdInt, username, flow, null);
      flow.setMxGraphModel(mxGraphModel);
  ...
  public static Stops xmlToStopsNew(String xmlData, int maxPageId, String username) {
    ...
    try {
      ...
      String isCheckpoint =
          StringCustomUtils.recoverSpecialSymbolsXml(stopElement.attributeValue("isCheckpoint"));
      String isCustomizedStr =
          StringCustomUtils.recoverSpecialSymbolsXml(stopElement.attributeValue("isCustomized"));
      String owner =
          StringCustomUtils.recoverSpecialSymbolsXml(stopElement.attributeValue("owner"));
      String groups =
          StringCustomUtils.recoverSpecialSymbolsXml(stopElement.attributeValue("groups"));
      ...
      if (null != customizedPropertyXmlIterator) {
        ...
        while (customizedPropertyXmlIterator.hasNext()) {
          ...
          String customValue =
              StringCustomUtils.recoverSpecialSymbolsXml(
                  customizedPropertyValue.attributeValue("customValue"));
          String propertyDescription =
              StringCustomUtils.recoverSpecialSymbolsXml(
                  customizedPropertyValue.attributeValue("description"));
          // String propertyId =
          // StringCustomUtils.recoverSpecialSymbolsXml(customizedPropertyValue.attributeValue("id"));
          String propertyName =
              StringCustomUtils.recoverSpecialSymbolsXml(
                  customizedPropertyValue.attributeValue("name"));
   ...
   * @return MxGraphModel
   */
  public static MxGraphModel xmlToMxGraphModelNew(
      String xmlData, int maxPageId, String username, Flow flow, FlowGroup flowGroup) {
    if (StringUtils.isBlank(xmlData)) {
      return null;
    }
    try {
   ...
   * @return MxCell
   */
  public static MxCell xmlToMxCell(
      String xmlData, int maxPageId, String username, MxGraphModel mxGraphModel) {
    if (StringUtils.isBlank(xmlData)) {
      return null;
    }
  ...
  public static Map<String, Object> xmlToStopsList(
      Iterator stopXmlIterator,
      int stopMaxPageIdInt,
      String username,
      String[] stopNames,
      Flow flow) {
    List<Stops> stopsList = new ArrayList<>();
    ...
    if (StringUtils.isNotBlank(duplicateStopName)) {
      return ReturnMapUtils.setFailedMsg(
          MessageConfig.DUPLICATE_NAME_PLEASE_MODIFY_MSG("StopName"));
    }
