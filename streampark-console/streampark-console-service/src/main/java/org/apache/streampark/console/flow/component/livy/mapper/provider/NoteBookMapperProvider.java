...
public class NoteBookMapperProvider {
  ...
  private boolean preventSQLInjectionNoteBook(NoteBook noteBook) {
    ...
    String lastUpdateDttm =
        DateUtils.dateTimesToStr(
            null != noteBook.getLastUpdateDttm() ? noteBook.getLastUpdateDttm() : new Date());
  ...
  public String getNoteBookList(boolean isAdmin, String username, String param) {
    ...
    if (StringUtils.isNotBlank(param)) {
      stringBuf.append(
          "crt_dttm LIKE CONCAT('%'," + SqlUtils.preventSQLInjection(param) + ",'%') ");
      stringBuf.append(
