...
import org.apache.streampark.console.flow.component.mxGraph.jpa.repository.MxCellJpaRepository;
import zio.schema.validation.Predicate$;

@Component
public class MxCellDomain {

  @Autowired private MxCellJpaRepository mxCellJpaRepository;

  private Specification<MxCell> addEnableFlagParam() {
    Specification<MxCell> specification =
        new Specification<MxCell>() {
          private static final long serialVersionUID = 1L;

          @Override
          public Predicate toPredicate(
              Root<MxCell> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
