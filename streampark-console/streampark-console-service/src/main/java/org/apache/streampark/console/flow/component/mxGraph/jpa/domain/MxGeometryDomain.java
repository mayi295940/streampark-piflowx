...
import org.apache.streampark.console.flow.component.mxGraph.jpa.repository.MxGeometryJpaRepository;
import zio.schema.validation.Predicate$;

@Component
public class MxGeometryDomain {

  @Autowired private MxGeometryJpaRepository mxGeometryJpaRepository;

  private Specification<MxGeometry> addEnableFlagParam() {
    Specification<MxGeometry> specification =
        new Specification<MxGeometry>() {
          private static final long serialVersionUID = 1L;

          @Override
          public Predicate toPredicate(
              Root<MxGeometry> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
  ...
  public MxGeometry getMxGeometryById(String id) {
    ...
    List<MxGeometry> mxGeometrys =
        mxGeometryJpaRepository.findAll(
