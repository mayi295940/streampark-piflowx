...
import org.apache.streampark.console.flow.component.mxGraph.jpa.repository.MxGraphModelJpaRepository;
import zio.schema.validation.Predicate$;

@Component
public class MxGraphModelDomain {

  @Autowired private MxGraphModelJpaRepository mxGraphModelJpaRepository;

  private Specification<MxGraphModel> addEnableFlagParam() {
    Specification<MxGraphModel> specification =
        new Specification<MxGraphModel>() {
          private static final long serialVersionUID = 1L;

          @Override
          public Predicate toPredicate(
              Root<MxGraphModel> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
  ...
  public MxGraphModel getMxGraphModelById(String id) {
    ...
    List<MxGraphModel> mxGraphModels =
        mxGraphModelJpaRepository.findAll(
