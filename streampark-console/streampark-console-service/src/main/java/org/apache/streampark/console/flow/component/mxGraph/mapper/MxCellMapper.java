...
public interface MxCellMapper {
    ...
    @Results({
            ...
            @Result(column = "id", property = "mxGeometry", one = @One(select = "org.apache.streampark.console.flow.component.mxGraph.mapper.MxGeometryMapper.getMxGeometryByMxCellId", fetchType = FetchType.LAZY))
    })
     ...
     * @param mxGraphModelId mxGraphModelId
     */
    @Select("select MAX(s.mx_pageid+0) from mx_cell s "
