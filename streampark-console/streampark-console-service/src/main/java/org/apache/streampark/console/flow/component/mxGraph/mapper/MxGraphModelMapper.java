...
public interface MxGraphModelMapper {
    ...
    @Results({
            ...
            @Result(column = "id", property = "root", many = @Many(select = "org.apache.streampark.console.flow.component.mxGraph.mapper.MxCellMapper.getMeCellByMxGraphId", fetchType = FetchType.LAZY))
    })
