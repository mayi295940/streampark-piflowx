...
public class MxGraphUtils {
  ...
  public static String mxGraphModelVoToMxGraphXml(MxGraphModelVo mxGraphModelVo) {
    ...
    if (null != mxGraphModelVo) {
      ...
      String pageHeight =
          StringCustomUtils.replaceSpecialSymbolsPage(mxGraphModelVo.getPageHeight());
      String background =
          StringCustomUtils.replaceSpecialSymbolsPage(mxGraphModelVo.getBackground());
      ...
      if (null != rootVoList && rootVoList.size() > 0) {
        for (MxCellVo mxCellVo : rootVoList) {
          ...
          if (null != mxGeometryVo) {
            String relative =
                StringCustomUtils.replaceSpecialSymbolsPage(mxGeometryVo.getRelative());
  ...
  public static String mxGraphModelToMxGraph(boolean isSaveXml, MxGraphModel mxGraphModel) {
    ...
    if (null != mxGraphModel) {
      ...
      String gridSize =
          StringCustomUtils.replaceSpecialSymbols(mxGraphModel.getGridSize(), isSaveXml);
      String guides = StringCustomUtils.replaceSpecialSymbols(mxGraphModel.getGuides(), isSaveXml);
      String tooltips =
          StringCustomUtils.replaceSpecialSymbols(mxGraphModel.getTooltips(), isSaveXml);
      String connect =
          StringCustomUtils.replaceSpecialSymbols(mxGraphModel.getConnect(), isSaveXml);
      ...
      String pageScale =
          StringCustomUtils.replaceSpecialSymbols(mxGraphModel.getPageScale(), isSaveXml);
      String pageWidth =
          StringCustomUtils.replaceSpecialSymbols(mxGraphModel.getPageWidth(), isSaveXml);
      String pageHeight =
          StringCustomUtils.replaceSpecialSymbols(mxGraphModel.getPageHeight(), isSaveXml);
      String background =
          StringCustomUtils.replaceSpecialSymbols(mxGraphModel.getBackground(), isSaveXml);
      xmlStrSb.append("<mxGraphModel ");
      if (StringUtils.isNotBlank(dx)) {
        xmlStrSb.append(spliceStr("dx", dx));
      }
      ...
      if (null != rootList && rootList.size() > 0) {
        for (MxCell mxCell : rootList) {
          ...
          if (null != mxGeometry) {
            String relative =
                StringCustomUtils.replaceSpecialSymbols(mxGeometry.getRelative(), isSaveXml);
            ...
            String width =
                StringCustomUtils.replaceSpecialSymbols(mxGeometry.getWidth(), isSaveXml);
            String height =
                StringCustomUtils.replaceSpecialSymbols(mxGeometry.getHeight(), isSaveXml);
            xmlStrSb.append("><mxGeometry ");
            if (StringUtils.isNotBlank(x)) {
              xmlStrSb.append(spliceStr("x", x));
            }
