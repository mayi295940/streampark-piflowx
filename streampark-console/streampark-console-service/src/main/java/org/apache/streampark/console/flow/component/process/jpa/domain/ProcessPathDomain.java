...
import org.apache.streampark.console.flow.component.process.jpa.repository.ProcessPathJpaRepository;
import zio.schema.validation.Predicate$;

@Component
public class ProcessPathDomain {

  @Autowired private ProcessPathJpaRepository processPathJpaRepository;

  private Specification<ProcessPath> addEnableFlagParam() {
    Specification<ProcessPath> specification =
        new Specification<ProcessPath>() {
          private static final long serialVersionUID = 1L;

          @Override
          public Predicate toPredicate(
              Root<ProcessPath> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
