...
import org.apache.streampark.console.flow.component.process.jpa.repository.ProcessStopPropertyJpaRepository;
import zio.schema.validation.Predicate$;

@Component
public class ProcessStopPropertyDomain {

  @Autowired private ProcessStopPropertyJpaRepository processStopPropertyJpaRepository;

  private Specification<ProcessStopProperty> addEnableFlagParam() {
    Specification<ProcessStopProperty> specification =
        new Specification<ProcessStopProperty>() {
          private static final long serialVersionUID = 1L;

          @Override
          public Predicate toPredicate(
              Root<ProcessStopProperty> root,
              CriteriaQuery<?> query,
