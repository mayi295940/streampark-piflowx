...
public interface ProcessGroupMapper {
    ...
    @Results({
            ...
            @Result(column = "id", property = "mxGraphModel", one = @One(select = "org.apache.streampark.console.flow.component.mxGraph.mapper.MxGraphModelMapper.getMxGraphModelByProcessGroupId", fetchType = FetchType.LAZY)),
            @Result(column = "id", property = "processList", many = @Many(select = "org.apache.streampark.console.flow.component.process.mapper.ProcessMapper.getProcessByProcessGroupId", fetchType = FetchType.LAZY)),
            @Result(column = "id", property = "processGroupList", many = @Many(select = "org.apache.streampark.console.flow.component.process.mapper.ProcessGroupMapper.getProcessGroupByProcessGroupId", fetchType = FetchType.LAZY)),
            @Result(column = "id", property = "processGroupPathList", many = @Many(select = "org.apache.streampark.console.flow.component.process.mapper.ProcessGroupPathMapper.getProcessPathByProcessGroupId", fetchType = FetchType.LAZY))
    })
    ...
    @Select("select app_id from flow_process_group "
        + "where enable_flag=1 "
