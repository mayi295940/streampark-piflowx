...
public interface ProcessMapper {
    ...
    @Results({
            ...
            @Result(column = "id", property = "mxGraphModel", one = @One(select = "org.apache.streampark.console.flow.component.mxGraph.mapper.MxGraphModelMapper.getMxGraphModelByProcessId", fetchType = FetchType.LAZY)),
            @Result(column = "id", property = "processPathList", many = @Many(select = "org.apache.streampark.console.flow.component.process.mapper.ProcessPathMapper.getProcessPathByProcessId", fetchType = FetchType.LAZY)),
            @Result(column = "id", property = "processStopList", many = @Many(select = "org.apache.streampark.console.flow.component.process.mapper.ProcessStopMapper.getProcessStopByProcessId", fetchType = FetchType.LAZY)),
            @Result(column = "fk_flow_process_group_id", property = "processGroup", one = @One(select = "org.apache.streampark.console.flow.component.process.mapper.ProcessGroupMapper.getProcessGroupById", fetchType = FetchType.LAZY)),
            @Result(column = "id", property = "flowGlobalParamsList", many = @Many(select = "org.apache.streampark.console.flow.component.flow.mapper.FlowGlobalParamsMapper.getFlowGlobalParamsByProcessId", fetchType = FetchType.LAZY))
    })
    ...
    @Select("select app_id from flow_process "
        + "where enable_flag=1 "
    ...
    @Select("select s.id from flow_process s "
