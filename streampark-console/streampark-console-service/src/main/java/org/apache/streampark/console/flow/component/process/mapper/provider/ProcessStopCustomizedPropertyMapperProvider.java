...
public class ProcessStopCustomizedPropertyMapperProvider {
    ...
    private boolean preventSQLInjectionProcessStopCustomizedProperty(
                                                                     ProcessStopCustomizedProperty processStopCustomizedProperty) {
        if (null == processStopCustomizedProperty
            || StringUtils.isBlank(processStopCustomizedProperty.getLastUpdateUser())) {
            return false;
        }
        // Mandatory Field
        ...
        this.lastUpdateUser =
            SqlUtils.preventSQLInjection(processStopCustomizedProperty.getLastUpdateUser());
        ...
        String processStopsIdStr =
            (null != processStopCustomizedProperty.getProcessStop()
                ? processStopCustomizedProperty.getProcessStop().getId()
                : null);
        this.processStopId =
            (null != processStopsIdStr ? SqlUtils.preventSQLInjection(processStopsIdStr) : null);
        return true;
    }
     ...
     *
     * @param map (Content: "processStopCustomizedPropertyList" with a value of
     *     "List<ProcessStopCustomizedProperty>")
     * @return
     */
    ...
    public String addProcessStopCustomizedPropertyList(Map map) {
        List<ProcessStopCustomizedProperty> processStopCustomizedPropertyList =
            (List<ProcessStopCustomizedProperty>) map.get("processStopCustomizedPropertyList");
        ...
        if (null != processStopCustomizedPropertyList && processStopCustomizedPropertyList.size() > 0) {
            ...
            for (ProcessStopCustomizedProperty processStopCustomizedProperty : processStopCustomizedPropertyList) {
                i++;
                boolean flag =
                    this.preventSQLInjectionProcessStopCustomizedProperty(processStopCustomizedProperty);
                if (flag) {
    ...
    public String addProcessStopCustomizedProperty(
                                                   ProcessStopCustomizedProperty processStopCustomizedProperty) {
     ...
     * @return
     */
    public String updateProcessStopCustomizedProperty(
                                                      ProcessStopCustomizedProperty processStopCustomizedProperty) {
        String sqlStr = "";
        boolean flag =
            this.preventSQLInjectionProcessStopCustomizedProperty(processStopCustomizedProperty);
     ...
     * @return
     */
    public String updateProcessStopCustomizedPropertyCustomValue(
                                                                 String username, String content, String id) {
        if (StringUtils.isBlank(username)) {
            return "SELECT 0";
        }
        if (StringUtils.isBlank(id)) {
