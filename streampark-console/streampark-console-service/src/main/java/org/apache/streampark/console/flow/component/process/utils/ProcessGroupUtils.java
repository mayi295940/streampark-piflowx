...
public class ProcessGroupUtils {
  ...
  public static ProcessGroup flowGroupToProcessGroup(
      FlowGroup flowGroup, String username, RunModeType runModeType, boolean isAddId) {
    if (null == flowGroup) {
      return null;
    }
  ...
  public static ProcessGroup copyProcessGroup(
      ProcessGroup processGroup, String username, RunModeType runModeType, boolean isAddId) {
  ...
  public static ProcessGroupPath copyProcessGroupPath(
      ProcessGroupPath processGroupPath, String username, boolean isAddId) {
