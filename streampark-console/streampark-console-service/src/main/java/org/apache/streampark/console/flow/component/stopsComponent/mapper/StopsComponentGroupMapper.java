...
public interface StopsComponentGroupMapper {
    ...
    @Results({
            ...
            @Result(column = "id", property = "stopsComponentList", many = @Many(select = "org.apache.streampark.console.flow.component.stopsComponent.mapper.StopsComponentMapper.getStopsComponentListByGroupId"))
    })
    ...
    @Results({
            @Result(id = true, column = "id", property = "id"),
            @Result(column = "id", property = "stopsComponentVoList", many = @Many(select = "org.apache.streampark.console.flow.component.stopsComponent.mapper.StopsComponentMapper.getManageStopsComponentListByGroupId"))
    })
     ...
     */
    @Insert("INSERT INTO flow_stops_groups(id,crt_dttm,crt_user,enable_flag,last_update_dttm,"
    ...
    @Insert("INSERT INTO association_groups_stops_template(groups_id,stops_template_id,engine_type)"
