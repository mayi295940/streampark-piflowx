...
public interface StopsComponentGroupMapper {
   ...
   */
  @Insert(
      "INSERT INTO flow_stops_groups(id,crt_dttm,crt_user,enable_flag,last_update_dttm,last_update_user,version,group_name) VALUES (#{id},#{crtDttm},#{crtUser},#{enableFlag},#{lastUpdateDttm},#{lastUpdateUser},#{version},#{groupName})")
  @Options(useGeneratedKeys = true, keyProperty = "id", keyColumn = "id")
  int insertStopGroup(StopsComponentGroup stopGroup);

  @Insert(
      "INSERT INTO association_groups_stops_template(groups_id,stops_template_id) VALUES (#{groups_id},#{stops_template_id})")
  ...
  List<StopsComponentGroup> getStopGroupByGroupNameList(
      @Param("group_name") List<String> groupName);
  ...
  @Delete(
      "delete from association_groups_stops_template where groups_id =#{groups_id} and stops_template_id = #{stops_template_id}")
