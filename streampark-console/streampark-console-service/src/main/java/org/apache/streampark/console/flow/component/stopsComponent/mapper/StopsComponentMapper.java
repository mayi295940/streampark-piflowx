...
public interface StopsComponentMapper {
    ...
    @Results({
            ...
            @Result(property = "properties", column = "id", many = @Many(select = "org.apache.streampark.console.flow.component.stopsComponent.mapper.StopsComponentPropertyMapper.getStopsComponentPropertyByStopsId"))
    })
    ...
    @Results({
            @Result(id = true, column = "id", property = "id"),
            @Result(column = "id", property = "properties", many = @Many(select = "org.apache.streampark.console.flow.component.stopsComponent.mapper.StopsComponentPropertyMapper.getStopsComponentPropertyByStopsId", fetchType = FetchType.LAZY))
    })
     ...
     * @param bundle bundle
     */
    @Select("select fst.* from flow_stops_template fst "
    ...
    @Select("select * from flow_stops_template where component_type = 'DEFAULT' and ENGINE_TYPE  = #{engineType}")
