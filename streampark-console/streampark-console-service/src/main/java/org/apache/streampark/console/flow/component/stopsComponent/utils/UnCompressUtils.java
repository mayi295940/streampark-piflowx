...
public class UnCompressUtils {
    ...
    public static String getImageName(String tempFilePath) throws Exception {
        ...
        /*
         * if (content.startsWith("[")) { content = content.substring(1, content.length() - 2); }
         * System.out.println("content = " + content); JSONObject json = JSONObject.parseObject(content.toString());
         * List<String> list = (List<String>) json.get("RepoTags"); System.out.println("list = " + list); return
         * list.get(0);
         */
    }
}
