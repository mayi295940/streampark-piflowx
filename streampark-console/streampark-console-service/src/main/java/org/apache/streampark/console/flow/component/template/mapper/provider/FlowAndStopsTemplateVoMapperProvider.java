...
public class FlowAndStopsTemplateVoMapperProvider {
  ...
  public String addPropertyList(Map map) {
    List<PropertyTemplateModel> propertyList =
        (List<PropertyTemplateModel>) map.get("propertyList");
    ...
    if (null != propertyList && propertyList.size() > 0) {
      ...
      for (PropertyTemplateModel property : propertyList) {
        ...
        String description =
            "null".equals(property.getDescription()) ? null : property.getDisplayName();
        ...
        sqlStrBuffer.append(
            SqlUtils.addSqlStr((crtDttm == null ? "" : DateUtils.dateTimesToStr(crtDttm))) + ",");
        ...
        sqlStrBuffer.append(
            SqlUtils.addSqlStrAndReplace((stops == null ? "" : stops.getId())) + ",");
