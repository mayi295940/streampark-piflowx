...
public class TestDataDomain {
   ...
   * @throws Exception
   */
  public int saveOrUpdateTestDataSchemaValuesList(
      String username, List<TestDataSchemaValues> schemaValuesList, TestData testData)
      throws Exception {
    ...
    for (TestDataSchemaValues testDataSchemaValues : schemaValuesList) {
      ...
      affectedRows +=
          updateTestDataSchemaValues(
              username, testDataSchemaValues, testDataSchemaValues.getTestDataSchema(), testData);
    }
    return affectedRows;
  }
  ...
  public int addTestDataSchema(TestDataSchema testDataSchema, String username) throws Exception {
    ...
    // affectedRows += addTestDataSchemaValuesList(username, testDataSchema.getSchemaValuesList(),
    // testDataSchema, testDataSchema.getTestData());
    return affectedRows;
  }
   ...
   * @throws Exception
   */
  public int addSchemaList(List<TestDataSchema> schemaList, TestData testData, String username)
      throws Exception {
   ...
   * @throws Exception
   */
  public int addTestDataSchemaValuesList(
      String username, List<TestDataSchemaValues> schemaValuesList, TestData testData)
      throws Exception {
    if (null == schemaValuesList) {
   ...
   * @throws Exception
   */
  public int addTestDataSchemaValues(
      String username, TestDataSchemaValues testDataSchemaValues, TestData testData)
      throws Exception {
  ...
  public int updateTestDataSchema(TestDataSchema testDataSchema, String username) throws Exception {
    ...
    // affectedRows += saveOrUpdateTestDataSchemaValuesList(username, false,
    // testDataSchema.getSchemaValuesList(), testDataSchema.getTestData());
    return affectedRows;
  }
   ...
   * @throws Exception
   */
  public int updateTestDataSchemaValues(
      String username,
  ...
  public int delTestData(String username, boolean isAdmin, String testDataId) {
    int affectedRows =
        testDataSchemaValuesMapper.delTestDataSchemaValuesByTestDataId(
            isAdmin, username, testDataId);
    affectedRows +=
        testDataSchemaMapper.delTestDataSchemaByTestDataId(isAdmin, username, testDataId);
   ...
   * @throws Exception
   */
  public int delTestDataSchemaList(List<String> schemaIdList, boolean isAdmin, String username)
      throws Exception {
    ...
    for (String schemaId : schemaIdList) {
      ...
      if (integer > 0) {
        affectedRows +=
            testDataSchemaValuesMapper.delTestDataSchemaValuesBySchemaId(
                isAdmin, username, schemaId);
      }
  ...
  public List<TestDataSchema> getTestDataSchemaListByTestDataIdSearch(
    ...
    return testDataSchemaMapper.getTestDataSchemaListByTestDataIdSearch(
  ...
  public List<TestDataSchemaVo> getTestDataSchemaVoListByTestDataIdSearch(
      boolean isAdmin, String username, String param, String testDataId) {
    return testDataSchemaMapper.getTestDataSchemaVoListByTestDataIdSearch(
        isAdmin, username, param, testDataId);
  }
   ...
   * @throws
   */
  public List<LinkedHashMap<String, Object>> getTestDataSchemaValuesCustomList(
      boolean isAdmin,
      String username,
      String testDataId,
      List<LinkedHashMap<String, Object>> fieldNameList) {
    if (null == fieldNameList) {
      return null;
    }
    return testDataSchemaValuesMapper.getTestDataSchemaValuesCustomList(
        isAdmin, username, testDataId, fieldNameList);
  }
   ...
   * @throws
   */
  public List<LinkedHashMap<String, Object>> getTestDataSchemaValuesCustomListId(
      boolean isAdmin,
      String username,
      String testDataId,
      List<LinkedHashMap<String, Object>> fieldNameList) {
    ...
    return testDataSchemaValuesMapper.getTestDataSchemaValuesCustomListId(
        isAdmin, username, testDataId, fieldNameList);
  }
