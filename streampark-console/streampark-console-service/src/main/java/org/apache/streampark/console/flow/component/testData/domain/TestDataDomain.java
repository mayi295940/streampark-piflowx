...
public class TestDataDomain {
    ...
    public int saveOrUpdateTestDataSchemaValuesList(
                                                    String username, List<TestDataSchemaValues> schemaValuesList,
    ...
    public int addTestDataSchemaValues(
                                       String username, TestDataSchemaValues testDataSchemaValues,
                                       TestData testData) throws Exception {
    ...
    public List<TestDataSchema> getTestDataSchemaListByTestDataIdSearch(
                                                                        boolean isAdmin, String username, String param,
                                                                        String testDataId) {
