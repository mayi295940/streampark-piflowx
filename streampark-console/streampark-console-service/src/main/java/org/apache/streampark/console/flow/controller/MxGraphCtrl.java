...
public class MxGraphCtrl {
  ...
  @Autowired private IFlowGroupService flowGroupServiceImpl;

  @Autowired private IMxGraphModelService mxGraphModelServiceImpl;

  @Autowired private IMxNodeImageService mxNodeImageServiceImpl;
