...
public class ProcessCtrl {
  ...
  @Autowired IProcessPathService processPathServiceImpl;
  ...
  @ResponseBody
  public String processAndProcessGroupListPage(
      @ApiParam(value = "page", required = true, example = "0") Integer page,
  ...
  public String drawingBoardData(
      @ApiParam(value = "loadId", required = true) String loadId,
  ...
  @ResponseBody
  public String queryProcessStopData(
      @ApiParam(value = "processId", required = true) String processId,
  ...
  @ResponseBody
  public String queryProcessPathData(
      @ApiParam(value = "processId", required = true) String processId,
      @ApiParam(value = "pageId", required = true) String pageId) {
  ...
  public String getCheckpoint(
      @ApiParam(value = "pID", required = true) String pID,
  ...
  public String getDebugData(
      @ApiParam(value = "appId", required = true) String appId,
