...
public class TestDataCtrl {
  ...
  @Resource private ITestDataService testDataServiceImpl;
  ...
  @ResponseBody
  public String saveOrUpdateTestDataSchema(
      @ApiParam(value = "testDataVo", required = true) RequestTestDataVo testDataVo)
      throws Exception {
  ...
  @ResponseBody
  public String checkTestDataName(
      @ApiParam(value = "testDataName", required = true) String testDataName) {
    String currentUsername = SessionUserUtil.getCurrentUsername();
    boolean isAdmin = SessionUserUtil.isAdmin();
  ...
  public String saveOrUpdateTestDataSchemaValues(
      @ApiParam(value = "schemaValuesVo", required = true)
          TestDataSchemaValuesSaveVo schemaValuesVo)
      throws Exception {
    String currentUsername = SessionUserUtil.getCurrentUsername();
    boolean isAdmin = SessionUserUtil.isAdmin();
  ...
  @ResponseBody
  public String testDataListPage(
      @ApiParam(value = "page", required = true) Integer page,
  ...
  @ResponseBody
  public String testDataSchemaList(
      @ApiParam(value = "param", required = false) String param,
      @ApiParam(value = "testDataId", required = true) String testDataId) {
    String currentUsername = SessionUserUtil.getCurrentUsername();
    boolean isAdmin = SessionUserUtil.isAdmin();
  ...
  @ResponseBody
  public String testDataSchemaValuesList(
      @ApiParam(value = "param", required = false) String param,
      @ApiParam(value = "testDataId", required = true) String testDataId) {
    String currentUsername = SessionUserUtil.getCurrentUsername();
    boolean isAdmin = SessionUserUtil.isAdmin();
