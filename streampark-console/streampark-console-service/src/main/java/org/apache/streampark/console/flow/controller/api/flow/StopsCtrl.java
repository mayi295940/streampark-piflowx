...
public class StopsCtrl {
  ...
  public String updateStopsNameById(String stopId, String flowId, String name, String pageId)
      throws Exception {
    String username = SessionUserUtil.getCurrentUsername();
  ...
  @ResponseBody
  @ApiOperation(
      value = "deleteRouterStopsCustomizedProperty",
      notes = "delete RouterStopsCustomizedProperty")
  ...
  @ResponseBody
  @ApiOperation(
      value = "getRouterStopsCustomizedProperty",
      notes = "get RouterStopsCustomizedProperty")
  ...
  public String updatePublishing(String publishingId, String name, String stopsIds) {
    boolean isAdmin = SessionUserUtil.isAdmin();
    String username = SessionUserUtil.getCurrentUsername();
    return flowStopsPublishingServiceImpl.updateFlowStopsPublishing(
        isAdmin, username, publishingId, name, stopsIds);
  }
  ...
  public String getPublishingList(Integer page, Integer limit, String param) {
    String username = SessionUserUtil.getCurrentUsername();
    boolean isAdmin = SessionUserUtil.isAdmin();
    return flowStopsPublishingServiceImpl.getFlowStopsPublishingListPager(
