package org.apache.streampark.console.flow.third.market.service.impl;
...
public class MarketImpl implements IMarket {
  ...
  public Map<String, Object> publishComponents(
    ...
    String doPost =
        HttpUtils.doPostComCustomizeHeaderAndFile(
            ApiConfig.getMarketComponentsListUrl(), headerParam, param, file, 50000);
  ...
  @Override
  public Map<String, Object> publishComponents(
      String accessKey, PublishComponentVo publishComponentVo, File file)
      throws JsonProcessingException {
    if (StringUtils.isBlank(accessKey)) {
      return ReturnMapUtils.setFailedMsg(
          MessageConfig.PARAM_IS_NULL_MSG("accessKey") + ",you need to bind market account!!");
    }
  ...
  public String searchComponents(String page, String pageSize, String param, String sort) {
    ...
    String doGet =
        HttpUtils.doGetComCustomizeHeader(
            ApiConfig.getMarketComponentsListUrl(), paramMap, 50000, headerParam);
    return doGet;
  }
