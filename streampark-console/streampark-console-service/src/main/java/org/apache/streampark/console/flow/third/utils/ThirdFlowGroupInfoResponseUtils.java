...
import org.apache.streampark.console.flow.third.vo.flowGroup.ThirdFlowInfoResponse;
import org.apache.streampark.console.flow.third.vo.flowGroup.ThirdFlowStopInfoOutResponse;
import org.apache.streampark.console.flow.third.vo.flowGroup.ThirdFlowStopInfoResponse;
...
public class ThirdFlowGroupInfoResponseUtils {
  ...
  public static ProcessGroup setProcessGroup(
      ProcessGroup processGroup, ThirdFlowGroupInfoResponse thirdFlowGroupInfoResponse) {
      ...
      if (CollectionUtils.isNotEmpty(flowGroups) && CollectionUtils.isNotEmpty(processGroupList)) {
        for (ThirdFlowGroupInfoOutResponse thirdFlowGroupInfoOutResponse_i : flowGroups) {
          if (null != thirdFlowGroupInfoOutResponse_i) {
            ThirdFlowGroupInfoResponse thirdFlowGroupInfoResponse_i =
                thirdFlowGroupInfoOutResponse_i.getGroup();
            if (null != thirdFlowGroupInfoResponse_i) {
              flowGrpupInfoResponseMap.put(
                  thirdFlowGroupInfoResponse_i.getName(), thirdFlowGroupInfoResponse_i);
            }
          }
        }
        for (ProcessGroup processGroup_i : processGroupList) {
          if (null != processGroup_i) {
            ThirdFlowGroupInfoResponse thirdFlowGroupInfoResponse_copy =
                flowGrpupInfoResponseMap.get(processGroup_i.getName());
