						...
						if (component_i_group && component_i_group.length > 0) {
							for (var j = 0; j < component_i_group.length; j++) {
								...
								if (component_i_group_j && '' !== component_i_group_j) {
									...
									component_param_i.dataParam = ('nodeType=' + component_param_i.nodeType + '&bundle=' + component_i_group_j.bundle);
									component_param_arrays.push(component_param_i);
								}
							}
						}
				...
				if (component_i_group && component_i_group.length > 0) {
					for (var j = 0; j < component_i_group.length; j++) {
						...
						if (component_i_group_j && '' !== component_i_group_j) {
							...
							// component_param_i.img_url = (component_i_group_j.img_name + component_i_group_j.img_type);
							component_param_i.img_url = component_i_group_j.imageUrl;
							component_param_i.bundle = component_i_group_j.bundle;
							if ('Group' === Sidebar.prototype.component_data.component_type) {
								...
								component_param_i.dataParam = ('nodeType=' + component_param_i.nodeType + '&bundle=' + component_param_i.bundle);
							}
							component_param_arrays.push(component_param_i);
						}
					}
