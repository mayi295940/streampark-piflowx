...
<script lang="ts">
  ...
  import textWorkerUrl from 'ace-builds/src-noconflict/mode-text';
  import scalaWorkerUrl from 'ace-builds/src-noconflict/mode-scala';
  import shWorkerUrl from 'ace-builds/src-noconflict/mode-sh';
  import pythonWorkerUrl from 'ace-builds/src-noconflict/mode-python';
  import javaWorkerUrl from 'ace-builds/src-noconflict/mode-java';
  import sqlWorkerUrl from 'ace-builds/src-noconflict/mode-sql';
  ...
  // 	import.meta.glob('file-loader!ace-builds/src-noconflict/snippets/javascript.js')
  // )
  // ace.config.setModuleUrl('ace/snippets/text', require('file-loader!ace-builds/src-noconflict/snippets/text.js'))
  // ace.config.setModuleUrl('ace/snippets/java', require('file-loader!ace-builds/src-noconflict/snippets/java.js'))
  // ace.config.setModuleUrl('ace/snippets/scala', require('file-loader!ace-builds/src-noconflict/snippets/scala.js'))
  // ace.config.setModuleUrl('ace/snippets/sql', require('file-loader!ace-builds/src-noconflict/snippets/sql.js'))
  // ace.config.setModuleUrl('ace/snippets/sh', require('file-loader!ace-builds/src-noconflict/snippets/sh.js'))
  // ace.config.setModuleUrl('ace/snippets/python', require('file-loader!ace-builds/src-noconflict/snippets/python.js'))
  ...
  export default defineComponent({
    ...
    setup(props) {
      const generateId = ref<GenerateId>(null);
      return {
        generateId,
      };
    },
    ...
    methods: {
      ...
      initEditor() {
        ...
        this.editor.on('change', () => {
          $emit(this, 'change', this.editor.getValue());
        });
      },
      // 实例方法，高亮某一行
      gotoLine(lineNumber) {
