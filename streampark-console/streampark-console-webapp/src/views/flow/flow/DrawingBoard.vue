<template>
  <div :style="{ height }">
    ...
    <Modal
      ...
      v-model:value="programming_Modal"
      width="60"
      @on-ok="updateStopsProperty"
      :mask-closable="false"
    >
      <div :style="{ height: `${Programming}` }">
        <RadioGroup size="small" v-model:value="buttonSize" type="button">
          ...
          <Radio label="javascript" :disabled="buttonSize === 'javascript' ? false : true"
            >java</Radio
          >
    ...
    <Modal
      :title="programming_Title"
      v-model:value="NeedSource_Modal"
      width="60"
      @on-ok="runParameters"
      :mask-closable="false"
    >
      <div :style="{ height: `${Programming}` }">
        <Tabs type="card" :value="tabName" @on-click="tabClick">
          <TabPane
            v-for="(tab, i) in queryJson.ports"
            :key="tab + i"
            :name="tab + i"
            :label="'Port：' + tab"
          >
            ...
            >
              ...
              <vxe-table-column field="description" title="Description"/>
              <vxe-table-column field="crtDttm" title="CrtDttm"/>
              <vxe-table-column title="Actions" width="70">
                <template #default="{ row }">
                  <Tooltip content="To View" placement="left">
                    <Button icon="md-search" @click="showDetailEvent(row)"/>
                  </Tooltip>
                </template>
              </vxe-table-column>
            </vxe-table>
    ...
    <Modal
      title="View Charts"
      v-model:value="visualization_Modal"
      width="60"
